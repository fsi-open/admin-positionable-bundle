...
namespace spec\FSi\Bundle\AdminPositionableBundle\Form\EventListener;
...
class SortableCollectionListenerSpec extends ObjectBehavior
{
    ...
    public function it_does_nothing_when_no_data(
        ...
        FormInterface $form,
        SortableInterface $item0,
        SortableInterface $item1,
        SortableInterface $item2
    ) {
    ...
    public function it_set_positions_for_two_collections_in_the_same_request(
        ...
        FormInterface $form1,
        SortableInterface $collection1Item0,
        SortableInterface $collection1Item1,
        SortableInterface $collection1Item2,
        FormEvent $form2Event1,
        FormEvent $form2Event2,
        FormInterface $form2,
        SortableInterface $collection2Item0,
        SortableInterface $collection2Item1,
        SortableInterface $collection2Item2
    ) {
